...
def rebuild():
    ...
    # Header
    html += f'<div class="header"><div style="display:flex;align-items:center;gap:12px"><div class="logo">YUCLAW <span>OS</span></div><div style="font-size:11px;color:#718096;font-family:JetBrains Mono"><span class="live-dot"></span>{now}</div></div><div style="display:flex;gap:6px"><a href="https://yuclawlab.github.io/yuclaw-brain" class="pill active">Terminal</a><a href="app.html" class="pill">Chat</a><a href="https://github.com/YuClawLab" class="pill">GitHub</a><a href="https://pypi.org/project/yuclaw" class="pill">PyPI</a></div></div>'
