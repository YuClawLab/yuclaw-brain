# Owner browser checklist — 8.0.0 candidate workbench (acceptance walk-through; NOT a Gate #15 study)
...
Record the outcome in your own words in the order reply; nothing here writes a record. If any line fails, that is a candidate defect and the designation waits.
