...
EVO_KINDS = ("EVO_CONFIG_SET", "EVO_VERSION_REGISTERED", "EVO_EVALUATION_RECORDED", "EVO_REVIEW_RECORDED", "EVO_FAILURE_RECORDED", "EVO_FAILURE_RESOLVED",
...
COM_KINDS = ("COM_BUDGET_SET", "COM_PACKET_SUBMITTED", "COM_COST_SET", "COM_TASK_TRANSITION", "COM_EFFORT_DECLARED", "COM_OVERRIDE_RECORDED",
             "COM_DISPUTE_RECORDED", "COM_APPEAL_RECORDED", "COM_DISPUTE_RESOLVED", "COM_ALIAS_RECORDED")
